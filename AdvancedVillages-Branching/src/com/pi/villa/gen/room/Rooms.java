...
public class Rooms {
	...
	static {		
		register(RoomRoadStraight.class,
				RoomRoadStraight.MAX_DISTANCE_FROM_CENTER,
				RoomRoadStraight.MAX_ROOM_COUNT,
				new HashMap<Class<? extends Room>, Integer>(),
				RoomRoadStraight.RARITY, RoomType.Path,
				Orientation.ROT_0, Orientation.ROT_90);
		register(RoomRoadCorner.class,
				RoomRoadCorner.MAX_DISTANCE_FROM_CENTER,
				RoomRoadCorner.MAX_ROOM_COUNT,
				new HashMap<Class<? extends Room>, Integer>(),
				RoomRoadCorner.RARITY, RoomType.Path,
				Orientation.ROT_0, Orientation.ROT_90,
				Orientation.ROT_180, Orientation.ROT_270);
		/*register(RoomRoadTee.class,
				RoomRoadTee.MAX_DISTANCE_FROM_CENTER,
				RoomRoadTee.MAX_ROOM_COUNT,
				new HashMap<Class<? extends Room>, Integer>(),
				RoomRoadTee.RARITY, RoomType.Path,
				Orientation.ROT_0, Orientation.ROT_90,
				Orientation.ROT_180, Orientation.ROT_270);
		register(RoomRoad4Way.class,
				RoomRoad4Way.MAX_DISTANCE_FROM_CENTER,
				RoomRoad4Way.MAX_ROOM_COUNT,
				new HashMap<Class<? extends Room>, Integer>(),
				RoomRoad4Way.RARITY, RoomType.Path,
				Orientation.ROT_0);*/
	}
