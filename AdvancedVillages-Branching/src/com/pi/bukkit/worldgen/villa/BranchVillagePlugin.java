...
import com.pi.villa.gen.room.RoomRoad4Way;

public class BranchVillagePlugin extends JavaPlugin implements
		CommandExecutor {
	...
	public void onEnable() {
		logMessage("Enabled");
		getCommand("branchvillage").setExecutor(this);
	}
	...
	public ChunkGenerator getDefaultWorldGenerator(String world,
			String id) {
		return new BranchVillageGenerator(this);
	}

	@Override
	public boolean onCommand(CommandSender commandsender,
			Command command, String s, String as[]) {
		if (s.trim().equalsIgnoreCase("branchvillage")) {
