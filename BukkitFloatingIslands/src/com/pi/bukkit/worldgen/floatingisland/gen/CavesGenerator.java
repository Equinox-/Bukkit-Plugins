...
public class CavesGenerator extends WorldGenBase {
	protected void a(long paramLong, int paramInt1, int paramInt2,
			byte[] chunkData, double paramDouble1, double paramDouble2,
			double paramDouble3) {
		a(paramLong, paramInt1, paramInt2, chunkData, paramDouble1,
				paramDouble2, paramDouble3, 1.0F + this.c.nextFloat() * 6.0F,
				0.0F, 0.0F, -1, -1, 0.5D);
	}
	...
	protected void a(long paramLong, int paramInt1, int paramInt2,
			...
			float paramFloat3, int paramInt3, int paramInt4, double paramDouble4) {
		...
		for (; paramInt3 < paramInt4; paramInt3++) {
			double d3 = 1.5D
					+ MathHelper.sin(paramInt3 * 3.141593F / paramInt4)
					* paramFloat1 * 1.0F;
			...
			f2 *= 0.9F;
			f1 *= 0.75F;
			f2 += (localRandom.nextFloat() - localRandom.nextFloat())
					* localRandom.nextFloat() * 2.0F;
			f1 += (localRandom.nextFloat() - localRandom.nextFloat())
					* localRandom.nextFloat() * 4.0F;

			if ((i == 0) && (paramInt3 == j) && (paramFloat1 > 1.0F)
					&& (paramInt4 > 0)) {
				a(localRandom.nextLong(), paramInt1, paramInt2, chunkData,
						paramDouble1, paramDouble2, paramDouble3,
						localRandom.nextFloat() * 0.5F + 0.5F,
						paramFloat2 - 1.570796F, paramFloat3 / 3.0F, paramInt3,
						paramInt4, 1.0D);
				a(localRandom.nextLong(), paramInt1, paramInt2, chunkData,
						paramDouble1, paramDouble2, paramDouble3,
						localRandom.nextFloat() * 0.5F + 0.5F,
			...
			if ((paramDouble1 < d1 - 16.0D - d3 * 2.0D)
					|| (paramDouble3 < d2 - 16.0D - d3 * 2.0D)
					|| (paramDouble1 > d1 + 16.0D + d3 * 2.0D)
					|| (paramDouble3 > d2 + 16.0D + d3 * 2.0D))
				continue;
			...
			for (int i6 = m; (i5 == 0) && (i6 < n); i6++) {
				for (int i7 = i3; (i5 == 0) && (i7 < i4); i7++) {
					for (int i8 = i2 + 1; (i5 == 0) && (i8 >= i1 - 1); i8--) {
						i9 = (i6 * 16 + i7) * 128 + i8;
						if ((i8 >= 0) && (i8 < 128)) {
							if ((chunkData[i9] == Block.WATER.id)
									|| (chunkData[i9] == Block.STATIONARY_WATER.id)) {
								i5 = 1;
							}
							if ((i8 != i1 - 1) && (i6 != m) && (i6 != n - 1)
									&& (i7 != i3) && (i7 != i4 - 1))
								i8 = i1;
						}
					}
			...
			for (int i6 = m; i6 < n; i6++) {
				...
				for (i9 = i3; i9 < i4; i9++) {
					double d10 = (i9 + paramInt2 * 16 + 0.5D - paramDouble3)
							/ d3;
					...
					if (d9 * d9 + d10 * d10 < 1.0D) {
						for (int i12 = i2 - 1; i12 >= i1; i12--) {
							...
							if ((d11 > -0.7D)
									&& (d9 * d9 + d11 * d11 + d10 * d10 < 1.0D)) {
								int i13 = chunkData[i10];
								if (i13 == Block.GRASS.id)
									i11 = 1;
								if ((i13 == Block.STONE.id)
										|| (i13 == Block.DIRT.id)
										|| (i13 == Block.GRASS.id)) {
									// if (i12 < 10) {
									// chunkData[i10] = (byte)
									...
									chunkData[i10] = 0;
									if ((i11 != 0)
											&& (chunkData[(i10 - 1)] == Block.DIRT.id))
										chunkData[(i10 - 1)] = this.d.getBiome(
												i6 + paramInt1 * 16, i9
														+ paramInt2 * 16).A;
									// }
								}
	...
	@Override
	protected void a(World paramWorld, int paramInt1, int paramInt2,
			int paramInt3, int paramInt4, byte[] chunkData) {
		int i = this.c.nextInt(this.c.nextInt(this.c.nextInt(40) + 1) + 1);
		...
		for (int j = 0; j < i; j++) {
			...
			double d2 = this.c.nextInt(this.c.nextInt(120) + 8);

			double d3 = paramInt2 * 16 + this.c.nextInt(16);

			int k = 1;
			if (this.c.nextInt(4) == 0) {
				a(this.c.nextLong(), paramInt3, paramInt4, chunkData, d1, d2,
						d3);
				k += this.c.nextInt(4);
			}
			...
			for (int m = 0; m < k; m++) {
				...
				if (this.c.nextInt(10) == 0)
					f3 *= (this.c.nextFloat() * this.c.nextFloat() * 3.0F + 1.0F);

				a(this.c.nextLong(), paramInt3, paramInt4, chunkData, d1, d2,
						d3, f3, f1, f2, 0, 0, 1.0D);
			}
		}
	}
}
