...
public class AdvancedVillageGenerator extends ChunkGenerator {

	private final AdvancedVillagePlugin plugin;

	public AdvancedVillageGenerator(AdvancedVillagePlugin plug) {
		this.plugin = plug;
	}
