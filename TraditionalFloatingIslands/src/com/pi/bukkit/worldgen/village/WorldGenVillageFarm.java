...
public class WorldGenVillageFarm extends WorldGenVillagePiece {
	...
	public WorldGenVillageFarm(int paramInt1,
			Random paramRandom,
	...
	public static WorldGenVillageFarm a(
		...
		StructureBoundingBox localStructureBoundingBox =
				StructureBoundingBox.a(paramInt1, paramInt2,
						paramInt3, 0, 0, 0, 7, 4, 9, paramInt4);
		...
		return new WorldGenVillageFarm(paramInt5, paramRandom,
	...
	public boolean a(World paramWorld, Random paramRandom,
		...
		a(paramWorld, paramStructureBoundingBox, 0, 1, 0, 6, 4,
				8, 0, 0, false);
		...
		a(paramWorld, paramStructureBoundingBox, 6, 0, 0, 6, 0,
				8, Block.LOG.id, Block.LOG.id, false);
		a(paramWorld, paramStructureBoundingBox, 1, 0, 0, 5, 0,
				0, Block.LOG.id, Block.LOG.id, false);
		a(paramWorld, paramStructureBoundingBox, 1, 0, 8, 5, 0,
				8, Block.LOG.id, Block.LOG.id, false);
 ...
 * Qualified Name: net.minecraft.server.WorldGenVillageFarm JD-Core Version:
 * 0.6.0
 */