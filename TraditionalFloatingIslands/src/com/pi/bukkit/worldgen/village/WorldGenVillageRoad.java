...
public class WorldGenVillageRoad extends
		WorldGenVillageRoadPiece {
	private int a;

	public WorldGenVillageRoad(int paramInt1,
			Random paramRandom,
		...
		this.a =
				Math.max(paramStructureBoundingBox.b(),
	...
	public void a(StructurePiece paramStructurePiece,
		...
		while (j < this.a - 8) {
			localStructurePiece =
					a((WorldGenVillageStartPiece) paramStructurePiece,
							paramList, paramRandom, 0, j);
			if (localStructurePiece != null) {
				j +=
						Math.max(localStructurePiece.g.b(),
								localStructurePiece.g.d());
				i = 1;
			}
		...
		while (j < this.a - 8) {
			localStructurePiece =
					b((WorldGenVillageStartPiece) paramStructurePiece,
							paramList, paramRandom, 0, j);
			if (localStructurePiece != null) {
				j +=
						Math.max(localStructurePiece.g.b(),
 ...
 * Qualified Name: net.minecraft.server.WorldGenVillageRoad JD-Core Version:
 * 0.6.0
 */